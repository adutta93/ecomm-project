...
const {isSignedIn, isAdmin, isAuthenticated,} = require('../controllers/authController');
...
const {getOrderById, createOrder, getAllOrders, getOrderStatus, updateOrderStatus} = require('../controllers/orderController');
